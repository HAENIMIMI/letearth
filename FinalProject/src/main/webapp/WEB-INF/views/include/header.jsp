<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <!--====== Title ======-->
    <title>Krowd - Crowdfunding Projects & Charity HTML Template</title>
    ...
    <!--====== Fontawesome css ======-->
    <link rel="stylesheet" href="../resourcesassets/css/font-awesome.min.css">
                        ...
                        <div class="main-header-item">
                            <div class="main-header-menus  d-flex justify-content-between align-items-center">
                                ...
                                <div class="header-logo">
                                    <a href="index.html"><img src="../resources/assets/images/logo.png" alt="logo"></a>
                                </div>
                                ...
                                <div class="header-info d-flex align-items-center ">
                                    ...
                                    <div class="info d-none d-sm-block">
                                        <img src="../resources/assets/images/header-icon.png" alt="">
                                        <span>Call Anytime</span>
                                        <h5 class="title">666 888 0000</h5>
                                    </div>
